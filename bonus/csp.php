...
<html lang="pt-br">
  ...
  <div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      <a href="http://localhost/dashboard/vulnshop/" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
        🛒 Vulnshop
      </a>
  ...
  <div class="container">
    ...
    <center>
        ...
        <input type="hidden" name="domain" value="site.com">
        <br>
...
<?php
        ...
        if(isset($_GET['busca'])){
			...
			header("Content-Security-Policy: script-src 'self' report-uri https://".$_GET['domain']);
