...
<html lang="pt-br">
  ...
  <div class="container">
    ...
    while ($row = $result->fetch_row()) {
        printf('Produto: <b>'.$row[2].'</b><br>');
        printf('Descrição: <b>'.$row[3].'</b><br>');
        printf('Vendedor: <b>'.$row[1].'</b><br>');
        printf('Preço: <b>R$ '.$row[5].'</b><br>');
    }
    ?>
    </h3>
    <a href="#" class="btn btn-primary">Fale com o vendedor</a>
    <br>
   </div>
    <br><br>
